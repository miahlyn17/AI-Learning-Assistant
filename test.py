    ...
    try:
        ...
        response = client.chat.completions.create(
            messages=[
                {
                    "role": "system",
                    "content":"You are a helpful AI teaching assistant. Reply in Markdown format with-structured sections and simulated Google Doc links."
                },
...
async def run_agents(topic, api_key):
    prompts = {
        ...
        "advisor": f"Design a structured learning roadmap for '{topic}', broken into beginner to expert levels. Include time estimates Google Doc links.",
        "librarian": f"Curate a list of high-quality resoruces (videos, docs, blogs) for learning '{topic}' with descriptions. Simulate Google Doc link.",
